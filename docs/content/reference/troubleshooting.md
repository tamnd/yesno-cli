...
Most of these come down to network reality or how yesno serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

yesno rate-limits like any public site. yesno already paces
...
Where a surface is gated, yesno reads a cookie or token you supply
...
`yesno`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what yesno actually did
