...
func TestHostWiring(t *testing.T) {
	...
	if want := "yesno://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("yesno", "about")
	if err != nil || got.String() != "yesno://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want yesno://page/about", got.String(), err)
	}
}
